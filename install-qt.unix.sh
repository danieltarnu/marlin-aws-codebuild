...
Examples
  ...
  ./install-qt.sh --version 5.14.1 --directory ~/Qt5.14.1.slient qtquickcontrols2 qtbase qtmultimedia qtconnectivity qt3d qtcharts qtquickcontrols qtdeclarative qtgraphicaleffects qtsvg qtsensors qtimageformats qtscript qtvirtualkeyboard qtlocation
